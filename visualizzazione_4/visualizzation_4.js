...
var root = am5.Root.new("chartdiv_vis_4");
...
createSeries("European country that make Medical document inspections", "mortality_yes");
createSeries("European country that do not make Medical document inspections", "mortality_no");
legend.data.setAll(chart.series.values);
