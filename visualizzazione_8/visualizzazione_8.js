am5.ready(function() {
  ...
  function createSeries(name, field, visibility=false) {
  ...
  createSeries("Turkey", "Turkey", true);
  ...
  createSeries("United Kingdom (England and Wales)", "United Kingdom (England and Wales)", true);
